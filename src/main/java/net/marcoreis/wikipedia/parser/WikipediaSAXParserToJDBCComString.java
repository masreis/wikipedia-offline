...
/**
 * Extremely slow. Use the StringBuilder version.
 * 
 * @author Marco Reis
 *
 */
...
public class WikipediaSAXParserToJDBCComString extends DefaultHandler {
    ...
    private static Logger logger = LoggerFactory.getLogger(WikipediaSAXParserToJDBCComString.class);
