...
public class WikipediaStaxParser {
    private static String nomeArquivo = System.getProperty("user.home") + "/dados/ptwiki-20130417-stub-articles.xml";
    private static final String PAGE = "page";
    private static final String TITLE = "title";
    private static int paginas = 0;
    private static Logger logger = LoggerFactory.getLogger(WikipediaStaxParser.class);
